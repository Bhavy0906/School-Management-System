...
public class Details {
    ...
    {
        System.out.println("Enter 1 if you are new to the system and want to signup.");
        System.out.println("Enter 2 if you are an existing user and want to login into you system");
    }
